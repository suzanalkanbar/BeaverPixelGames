...
class mainScene {
    preload() {
        ...
        let loadfishes = ['anglerfish','bass','blue','bluegill','bluetang','bonefish','burningfish','burntfish','cancer','catfish','clownfish','cod','crappie','dolphin','eel','ghostfish','lavaeel','magmablob','moonjelly','northernpike','octopus','pisces','sailfish','salmon','starfish','stonefish','trout','tuna','turtle','walleye','yellowperch']
        for (let i = 0; i<loadfishes.length;i++){
            this.load.image(loadfishes[i],'catFish_2/assets/fish/'+loadfishes[i]+'.png')
        }
    }
    create() {
        ...
        this.fish1 = this.physics.add.sprite(100, 100, 'bass')
        this.fishMaker(this.fish1, 50, 10, 70, 30, 5, 'Lake', 'bass', 0)
        this.fish2 = this.physics.add.sprite(100, 100, 'bluegill')
        this.fishMaker(this.fish2, 40, 9, 70, 30, 10, 'Lake', 'bluegill', 0)
        this.fish3 = this.physics.add.sprite(100, 100, 'crappie')
        this.fishMaker(this.fish3, 30, 8, 70, 30, 20, 'Lake', 'crappie', 0)
        this.fish4 = this.physics.add.sprite(100, 100, 'northernpike')
        this.fishMaker(this.fish4, 20, 7, 70, 30, 30, 'Lake', 'northernpike', 0)
        this.fish5 = this.physics.add.sprite(100, 100, 'walleye')
        this.fishMaker(this.fish5, 20, 5, 70, 30, 50, 'Lake', 'walleye', 0)
        this.fish6 = this.physics.add.sprite(100, 100, 'yellowperch')
        this.fishMaker(this.fish6, 10, 4, 70, 30, 120, 'Lake', 'yellowperch', 1)
        this.fish7 = this.physics.add.sprite(100, 100, 'trout')
        this.fishMaker(this.fish7, 10, 3, 70, 30, 500, 'Lake', 'trout', 2)
        this.fish8 = this.physics.add.sprite(100, 100, 'catfish')
        this.fishMaker(this.fish8, 5, 2, 70, 30, 2500, 'Lake', 'catfish', 3)

        this.fish9 = this.physics.add.sprite(100, 100, 'red')
        this.fishMaker(this.fish9, 20, 6, 80, 20, 25, 'Beach', 'red', 0)
        this.fish10 = this.physics.add.sprite(100, 100, 'clownfish')
        this.fishMaker(this.fish10, 18, 5, 80, 20, 50, 'Beach', 'clownfish', 0)
        this.fish11 = this.physics.add.sprite(100, 100, 'bluetang')
        this.fishMaker(this.fish11, 16, 5, 80, 20, 100, 'Beach', 'bluetang', 0)
        this.fish12 = this.physics.add.sprite(100, 100, 'cod')
        this.fishMaker(this.fish12, 12, 4, 80, 20, 200, 'Beach', 'cod', 0)
        this.fish13 = this.physics.add.sprite(100, 100, 'salmon')
        this.fishMaker(this.fish13, 8, 4, 80, 20, 400, 'Beach', 'salmon', 0)
        this.fish14 = this.physics.add.sprite(100, 100, 'tuna')
        this.fishMaker(this.fish14, 6, 4, 80, 20, 500, 'Beach', 'tuna', 1)
        this.fish15 = this.physics.add.sprite(100, 100, 'eel')
        this.fishMaker(this.fish15, 4, 2, 80, 20, 750, 'Beach', 'eel', 2)
        this.fish16 = this.physics.add.sprite(100, 100, 'blue')
        this.fishMaker(this.fish16, 3, 1, 80, 20, 3250, 'Beach', 'blue', 3)

        this.fish17 = this.physics.add.sprite(100, 100, 'burntfish')
        this.fishMaker(this.fish17, 10, 3, 90, 10, 100, 'Lava', 'burntfish', 0)
        this.fish18 = this.physics.add.sprite(100, 100, 'stonefish')
        this.fishMaker(this.fish18, 9, 2, 90, 10, 125, 'Lava', 'stonefish', 0)
        this.fish19 = this.physics.add.sprite(100, 100, 'bonefish')
        this.fishMaker(this.fish19, 7, 2, 90, 10, 250, 'Lava', 'bonefish', 0)
        this.fish20 = this.physics.add.sprite(100, 100, 'anglerfish')
        this.fishMaker(this.fish20, 6, 1, 90, 10, 500, 'Lava', 'anglerfish', 0)
        this.fish21 = this.physics.add.sprite(100, 100, 'sailfish')
        this.fishMaker(this.fish21, 5, 1, 90, 10, 750, 'Lava', 'sailfish', 0)
        this.fish22 = this.physics.add.sprite(100, 100, 'magmablob')
        this.fishMaker(this.fish22, 4, 1, 90, 10, 1000, 'Lava', 'magmablob', 1)
        this.fish23 = this.physics.add.sprite(100, 100, 'lavaeel')
        this.fishMaker(this.fish23, 3, 1, 90, 10, 2000, 'Lava', 'lavaeel', 2)
        this.fish24 = this.physics.add.sprite(100, 100, 'burningfish')
        this.fishMaker(this.fish24, 2, 1, 90, 10, 5000, 'Lava', 'burningfish', 3)

        this.fish25 = this.physics.add.sprite(100, 100, 'starfish')
        this.fishMaker(this.fish25, 8, 1, 60, 40, 250, 'Space', 'starfish', 0)
        this.fish26 = this.physics.add.sprite(100, 100, 'moonjelly')
        this.fishMaker(this.fish26, 7, 1, 60, 40, 500, 'Space', 'moonjelly', 0)
        this.fish27 = this.physics.add.sprite(100, 100, 'ghostfish')
        this.fishMaker(this.fish27, 6, 1, 60, 40, 750, 'Space', 'ghostfish', 0)
        this.fish28 = this.physics.add.sprite(100, 100, 'turtle')
        this.fishMaker(this.fish28, 5, 1, 60, 40, 1000, 'Space', 'turtle', 0)
        this.fish29 = this.physics.add.sprite(100, 100, 'dolphin')
        this.fishMaker(this.fish29, 4, 1, 60, 40, 1500, 'Space', 'dolphin', 0)
        this.fish30 = this.physics.add.sprite(100, 100, 'octopus')
        this.fishMaker(this.fish30, 3, 1, 60, 40, 2000, 'Space', 'octopus', 1)
        this.fish31 = this.physics.add.sprite(100, 100, 'cancer')
        this.fishMaker(this.fish31, 2, 1, 60, 40, 2500, 'Space', 'cancer', 2)
        this.fish32 = this.physics.add.sprite(100, 100, 'pisces')
        this.fishMaker(this.fish32, 1, 1, 60, 40, 7500, 'Space', 'pisces', 3)

        this.fish33 = this.physics.add.sprite(100, 100, 'purple')
        this.fishMaker(this.fish33, 1, 0, 80, 20, 80, 'Space', 'purple', 3)
